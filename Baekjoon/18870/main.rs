...
fn lower_bound(array: &Vec<i32>, key: i32) -> usize {
    let mut left: i32 = 0;
...
fn main() {
    ...
    let array: Vec<i32> = line.next_iter().take(n).collect();
    let mut sorted_array = array.clone();
    sorted_array.sort();
    sorted_array.dedup();

    for num in array.iter() {
        let idx = lower_bound(&sorted_array, *num);
